...
public class YouTubeUriExtractor {
    ...
    protected void onPostExecute(SparseArray<YtFile> ytFiles, OnYoutubeParseListener onYoutubeParseListener) {
//        onUrisAvailable(youtubeID, videoTitle, ytFiles);
        if (onYoutubeParseListener != null) {
            onYoutubeParseListener.onUrisAvailable(youtubeID, videoTitle, ytFiles);
        }
    }

//    public abstract void onUrisAvailable(String videoId, String videoTitle, SparseArray<YtFile> ytFiles);

    public void parseInBackground(String url, OnYoutubeParseListener onYoutubeParseListener) {
        youtubeID = null;
        String ytUrl = url;
        if (ytUrl == null) {
            return;
        ...
        if (youtubeID != null) {
            try {
                onPostExecute(getStreamUrls(), onYoutubeParseListener);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
